...
function delete_lead(url)
{
	...
	if (confirm("If you delete this lead all the data of this lead including contacts, call history, notes will be deleted permanentantly.\nDo you still want to delete this lead?")==true){
...
{
	if (confirm("Are you sure, you want to convert this opportunity to customer?") == true) {
    window.location.href = url;
	}
}
...
{
	if (confirm("Are you sure, you want to convert this lead to opportunity?") == true) {
    window.location.href = url;
	}
}
...
{
	if (confirm("Are you sure, you want to remove this opportunity image?") == true) {
    window.location.href = url;
	}
}
/////////////////////////////////////////Customers Menu////////////////////////////////////////////////
...
function delete_customer(url)
{
	...
	if (confirm("If you delete this customer all the data of this customer including appointments, quotations, invoices, tickets  will be deleted permanentantly.\nDo you still want to delete this customers?")==true){
...
{
	if (confirm("Are you sure, you want to delete this quotation?") == true) {
    window.location.href = url;
	}
}
...
{
	if (confirm("Are you sure, you want to delete this tax class?") == true) {
    window.location.href = url;
	}
}
...
{
	if (confirm("Are you sure, you want to delete this "+txt+"?") == true) {
    window.location.href = url;
	}
}
/////////////////////////////////////////Marketing////////////////////////////////////////////////
...
{
	if (confirm("Are you sure, you want to cancel this process?") == true) {
    window.location.href = url;
	}
}
...
{
		if (confirm("Are you sure, you want to delete this lead report?") == true) {
    			window.location.href = url;
		}
}
...
{
		if (confirm("Are you sure, you want to delete this opportunity report?") == true) {
    			window.location.href = url;
		}
}
...
{
		if (confirm("Are you sure, you want to delete this customer report?") == true) {
    			window.location.href = url;
		}
}
